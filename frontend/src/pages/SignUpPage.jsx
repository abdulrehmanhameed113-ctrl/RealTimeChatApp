...
export default function SignUpPage() {
  ...
  const inputStyle = (hasError) => ({
    ...
    border: hasError ? "1px solid #ef4444" : "1px solid var(--wa-border)",
  });
    ...
    >
      ...
      >
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              onFocus={(e) => {
                if (!errors.name) e.target.style.borderColor = "var(--wa-green)";
              }}
              onBlur={(e) => {
                if (!errors.name) e.target.style.borderColor = "var(--wa-border)";
              }}
            />
            {errors.name && (
        ...
        <p className="text-center text-xs mt-5" style={{ color: "var(--wa-text-secondary)" }}>
          ...
          <Link to="/login" className="font-semibold" style={{ color: "var(--wa-green)" }}>
            Sign in
          </Link>
        </p>
      </div>
